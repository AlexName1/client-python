...
class PurchasesApi(object):
    ...
    def get_all_temporally_api_v1_purchases_temporally_bot_id_get(self, bot_id, **kwargs):  # noqa: E501
        """Get All Temporally  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_temporally_api_v1_purchases_temporally_bot_id_get(bot_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_all_temporally_api_v1_purchases_temporally_bot_id_get_with_http_info(bot_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_all_temporally_api_v1_purchases_temporally_bot_id_get_with_http_info(bot_id, **kwargs)  # noqa: E501
            return data

    def get_all_temporally_api_v1_purchases_temporally_bot_id_get_with_http_info(self, bot_id, **kwargs):  # noqa: E501
        """Get All Temporally  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_temporally_api_v1_purchases_temporally_bot_id_get_with_http_info(bot_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_all_temporally_api_v1_purchases_temporally_bot_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('bot_id' not in params or
            ...
            raise ValueError("Missing the required parameter `bot_id` when calling `get_all_temporally_api_v1_purchases_temporally_bot_id_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/purchases/temporally/{bot_id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
