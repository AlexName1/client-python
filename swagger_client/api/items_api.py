...
class ItemsApi(object):
    ...
    def get_all_api_v1_items_get(self, token, **kwargs):  # noqa: E501
        """Get All  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_api_v1_items_get(token, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str token: (required)
        :return: list[ItemBaseDb]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_all_api_v1_items_get_with_http_info(token, **kwargs)  # noqa: E501
        else:
            (data) = self.get_all_api_v1_items_get_with_http_info(token, **kwargs)  # noqa: E501
            return data

    def get_all_api_v1_items_get_with_http_info(self, token, **kwargs):  # noqa: E501
        """Get All  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_api_v1_items_get_with_http_info(token, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_all_api_v1_items_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('token' not in params or
            ...
            raise ValueError("Missing the required parameter `token` when calling `get_all_api_v1_items_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='list[ItemBaseDb]',  # noqa: E501
