...
class InfoItemsApi(object):
    ...
    def update_new_api_v1_info_items_token_new_put(self, body, token, **kwargs):  # noqa: E501
        """Update New  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_new_api_v1_info_items_token_new_put(body, token, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param InfoItemUpdateNew body: (required)
        :param str token: (required)
        :return: object
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_new_api_v1_info_items_token_new_put_with_http_info(body, token, **kwargs)  # noqa: E501
        else:
            (data) = self.update_new_api_v1_info_items_token_new_put_with_http_info(body, token, **kwargs)  # noqa: E501
            return data

    def update_new_api_v1_info_items_token_new_put_with_http_info(self, body, token, **kwargs):  # noqa: E501
        """Update New  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_new_api_v1_info_items_token_new_put_with_http_info(body, token, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_new_api_v1_info_items_token_new_put" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_new_api_v1_info_items_token_new_put`")  # noqa: E501
        # verify the required parameter 'token' is set
        if ('token' not in params or
                params['token'] is None):
            raise ValueError("Missing the required parameter `token` when calling `update_new_api_v1_info_items_token_new_put`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v1/info-items/{token}/new', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
